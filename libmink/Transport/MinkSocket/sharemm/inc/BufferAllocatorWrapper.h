...
//                                unsigned int legacy_ion_heap_mask, unsigned
//                                legacy_ion_heap_flags);

int32_t DmabufHeapCpuSyncStart(BufferAllocator* buffer_allocator, unsigned int dmabuf_fd,
                               SyncType sync_type,  // int (*legacy_ion_cpu_sync)(int, int, void *),
                               void* legacy_ion_custom_data);

int32_t DmabufHeapCpuSyncEnd(BufferAllocator* buffer_allocator, unsigned int dmabuf_fd,
                             SyncType sync_type,  // int (*legacy_ion_cpu_sync)(int, int, void*),
                             void* legacy_ion_custom_data);
