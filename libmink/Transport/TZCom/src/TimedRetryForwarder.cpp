 ...
 * ******************************************************************/
/*
 * NOTE: PLEASE READ THIS BEFORE USING THIS API!!!
 *
 * Clients may choose whether or not to use the Timedretry framework to wrap
 * objects with retries.
 *
 * Clients can keep their code unchanged with TimedRetryForwarder_new.
 * However, the configuration of retry timeout and interval values will be
 * implicitly managed by the minkdescriptor layer with *DEFAULT* values as
 * retry logic is now embedded in minkdescriptor layer.
 */
