 ...
 */
#define c_offsetof(type, member) (((uintptr_t) & ((type *)0x100)->member) - 0x100)
 ...
 */
#define C_FOR_ARRAY(var, array) for (var = 0; var < C_LENGTHOF(array); ++var)
 ...
 */
#define C_ZERO_RANGE(ptr, len) memset((ptr), 0, (len) * sizeof *(ptr))
